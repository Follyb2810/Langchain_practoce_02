...
memory.chat_memory.add_user_message("So which one should I use if I want to keep the entire history?")
memory.chat_memory.add_ai_message("You should use ConversationBufferMemory for the full history. "
                                  "If you only want the last k turns, use ConversationBufferWindowMemory.")
memory.chat_memory.add_user_message("Can you give me a quick code example of BufferWindowMemory?")
memory.chat_memory.add_ai_message("Sure! You can initialize it with something like:\n\n"
                                  "```python\n"
